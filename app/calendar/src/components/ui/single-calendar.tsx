...
function SingleCalendar({ className, classNames, showOutsideDays = true, selected, ...props }: Props) {
  ...
  return (
    <DayPicker
      ...
      // react-day-picker component types are a bit strict here; cast to any for our simple icons
      components={{
